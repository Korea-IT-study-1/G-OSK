...
전에 했던 사이트와 달리 이번에는 키오스크 버전으로 만들어보니깐 화면 구성이 적어서 조금 더 기능에 중점을 두고 했던 것이 좋았습니다. 확실히 프로젝트를 해본 분들 하고 같이 하니 속도도 그렇고 작업능률이 높아졌던 것 같습니다. 또한 협업을 하다 보니 문제가 생겼을 때 다른 분들의 의견을 듣고 "아, 이런 방식도 되겠구나!"라는 생각도 들고 어떻게 해야 조금 더 좋은 코드를 짤 수 있을까라는 생각을 했었습니다. 아직도 부족한 부분들이 조금 보였지만 앞으로는 부족한 부분을 빨리 메꿔야겠다는 생각이 들었고 함께하는 시간 동안 많은 것들을 배운 것 같아서 좋았습니다.

> 문창배

처음 이 프로젝트르 시작할때는 키오스크가 간단한 프로젝트일 줄 알았는데 막상 시작하고 보니 기능적인 부분에 시간을 더 들여야해서 생각보다 어려웠는데, 서로 의견도 주고 받으며 해결해나가는 것에 뿌듯하기도 했습니다. 지금까지 공부한 것으로는 아직 혼자서 여러 기능을 구현하기에는 많이 부족하다는 것을 다시 깨닫게 되었고, 다른 분들의 방식도 많이 배울 수 있어서 이번 프로젝트에서 많은 것들을 배워가는 것 같아 좋았습니다. 
